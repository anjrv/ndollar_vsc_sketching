...
public enum Direction {
    ...
    NNE() {
        ...
        public double getMiddleDirection() {
            return (getLowerDegreeLimit() + getHigherDegreeLimit()) / 2;
        }
     ...
     */
    private static final int numberOfDirections = 16;
    private static final int numberOfMaximumDegrees = 360;
     ...
     */
    public static int getNumberOfMaximumDegrees() {
        return numberOfMaximumDegrees;
    }
    ...
    public static Direction getDirectionByIndex(int index) {
        int indexMod = index % getNumberOfDirections();
        switch (indexMod) {
            case 0:
                return N;
            case 1:
